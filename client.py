    ...
    if not (game.connected()):
        ...
        if game.bothWent():
            ...
            if game.p1Went and p == 0:
                ...
                text1 = font.render("Entered", 1, (0, 0, 0))
            else:
            ...
            if game.p2Went and p == 1:
                ...
                text2 = font.render("Entered", 1, (0, 0, 0))
            else:
...
def menu_screen():
    ...
    player += 1
    player = str(player)
    text = font.render('You are Player', 1, (255, 0, 0))
    win.blit(text, (180, 200))
    text = font.render(player, 1, (255, 0, 0))
    win.blit(text, (490, 200))
    text = font.render("Click to Play!", 1, (255, 0, 0))
    win.blit(text, (190, 250))
    pygame.display.update()
    play_screen = True
    while play_screen:
        for event in pygame.event.get():
